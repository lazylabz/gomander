...
export const URLS = {
	...
	contributing:
		"https://github.com/lazylabz/gomander-app?tab=readme-ov-file#contributing",
...
export const PAINS = [
	{
		k: "01",
		t: "10+ Terminal Windows",
		d: "Your desktop becomes a maze of terminal tabs",
	},
	{
		k: "02",
		t: "Lost in the Chaos",
		d: "Which process crashed? Where's that error?",
	},
	{
		k: "03",
		t: "Slow Team Onboarding",
		d: "New devs spend hours figuring out what to run",
	},
...
const RELEASE_BASE =
	"https://github.com/lazylabz/gomander-app/releases/latest/download";
	...
	macOS: [
		{
			arch: "Apple Silicon",
			label: "arm64",
			file: "gomander-darwin-arm64.dmg",
		},
	...
	Windows: [
		{
			arch: "arm64",
			label: "arm64",
			file: "gomander-windows-arm64-installer.exe",
		},
		{
			arch: "amd64",
			label: "amd64",
			file: "gomander-windows-amd64-installer.exe",
		},
	],
} as const;
